            ...
            <div class="card">
                <div class="card-header p-3 pt-2">
                    ...
                    <div class="text-end pt-1">
                        <p class="text-sm mb-0 text-capitalize"><b>DATA USER</b></p>
            ...
            <div class="card">
                <div class="card-header p-3 pt-2">
                    ...
                    <div class="text-end pt-1">
                        ...
                        <h4 class="mb-0">{{ $total_kelas ?? 0 }}</h4>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-header p-3 pt-2">
                    ...
                    <div class="text-end pt-1">
                        ...
                        <h4 class="mb-0">{{ $total_siswa ?? 0 }}</h4>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <ul class="list-group">
                        @foreach ($pengumumans as $pengumuman)
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                ...
                                <div class="col-md-4 text-end">
                                    ...
                                    <button class="btn btn-sm btn-warning edit-notification" 
                                            ...
                                            data-bs-target="#editPengumuman{{ (string)$pengumuman->_id }}">
                                        <i class="fa fa-edit"></i>
                                    </button>
                                    <a href="/dashboard/hapus-pengumuman/{{ (string)$pengumuman->_id }}" 
                            ...
                            <div class="modal fade" 
                                 id="editPengumuman{{ (string)$pengumuman->_id }}" 
                                 tabindex="-1" 
                                 role="dialog" 
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        {{-- ⚠️ Perbaiki nama parameter menjadi 'id' --}}
                                        <form method="post" action="{{ route('update-pengumuman', ['id' => (string)$pengumuman->_id]) }}">
                                            @csrf
                                            @method('PUT')
                                            <div class="modal-body">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control" 
                                                              ...
                                                              name="message" 
                                                              rows="4" 
                                                              required>{{ $pengumuman->message }}</textarea>
                                                </div>
                                                <div class="mb-3">
                                                    ...
                                                    @foreach ($availableRoles as $roleOption)
                                                        <div class="form-check">
                                                            <input class="form-check-input" 
                                                                   ...
                                                                   name="roles[]" 
                                                                   value="{{ $roleOption }}" 
                                                                   id="role{{ $roleOption }}_{{ (string)$pengumuman->_id }}"
                                                                   @if($roleOption === $pengumuman->role) checked @endif>
                                                            <label class="form-check-label" for="role{{ $roleOption }}_{{ (string)$pengumuman->_id }}">
                                                                {{ ucfirst($roleOption) }}
                                                            </label>
                                                        </div>
                                                    @endforeach
