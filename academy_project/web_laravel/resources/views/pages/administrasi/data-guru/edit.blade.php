        ...
        <div class="col-12">
            <div class="card my-4">
                ...
                @php
                    ...
                    // Alamat dari guru_data
                    $alamat_array = explode(',', $guruData['alamat'] ?? '');
                    ...
                    $form_input = [
                        ...
                        'status' => $guruData['status_pegawai'] ?? 'magang',
                ...
                <div class="card-body px-0 pb-2">
                    {{-- MONGODB: Gunakan _id bukan id --}}
                    <form action="/administrasi/guru-update/{{ (string)$guru->_id }}" class="row g-3 py-1 px-4" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input id="nip" type="text" onkeypress="return hanyaAngka(event)" name="nip"
                                    ...
                                    value="{{ $form_input['nip'] }}" readonly disabled>
                            </div>
                            @if ($errors->has('nip'))
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input id="no_telp" type="text" maxlength="13" onkeypress="return hanyaAngka(event)"
                                    name="no_telp" class="form-control rounded-3" required
                                    value="{{ $form_input['no_telp'] }}" readonly disabled>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <select class="form-select rounded-3 form-control-lg text-sm" name="agama" id="agama" disabled readonly>
                                    <option selected>-- Pilih Agama --</option>
                                    @foreach ($agamas as $agama)
                                        <option value="{{ $agama }}" @if ($form_input['agama'] == $agama) selected @endif>
                                            {{ ucfirst($agama) }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="input-group">
                                <input type="text" name="tempat_lahir" class="form-control rounded-3" required disabled
                                    value="{{ $form_input['tempat_lahir'] }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="input-group">
                                <input type="date" name="tanggal_lahir" class="form-control rounded-3" required disabled
                                    value="{{ $form_input['tanggal_lahir'] }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6" style="display: flex; flex-wrap: wrap; gap: 10px">
                            @foreach (['provinsi', 'kabupaten', 'kecamatan', 'desa'] as $alamat_detail)
                                <div class="" style="flex-grow: 1; min-width: 218px;">
                                    <label for="alamat-{{ $alamat_detail }}" class="form-label">{{ ucfirst($alamat_detail) }}</label>
                                    <div class="input-group">
                            ...
                            <div class="" style="flex-grow: 1; min-width: 218px;">
                                ...
                                <div class="input-group">
                                    <textarea name="alamat[lanjutan]" class="form-control rounded-3" id="alamat-lanjutan"
                            ...
                            @foreach (['laki-laki', 'perempuan'] as $gender)
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="jenis_kelamin"
                                        id="{{ $gender }}" value="{{ $gender }}" required disabled
                                        @if ($form_input['jenis_kelamin'] == $gender) checked @endif>
                        ...
                        <div class="col-md-6">
                            ...
                            @foreach ($status_gurus as $status_guru)
                                <div class="form-check form-check-inline">
                                    ...
                                    <label class="form-check-label" for="{{ $status_guru }}">{{ ucfirst($status_guru) }}</label>
                                </div>
                            @endforeach
                        </div>
                        ...
                        <div class="card-footer d-flex justify-content-end" style="gap: 10px">
                            <a href="/administrasi/guru" class="btn btn-danger text-sm rounded-3" style="margin-bottom: 0;">
