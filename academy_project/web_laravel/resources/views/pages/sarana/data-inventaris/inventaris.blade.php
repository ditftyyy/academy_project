        ...
        <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                    <h6 class="text-white text-capitalize ps-3">Daftar Ruang</h6>
                </div>
            </div>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    @if (auth()->user()->hasRole('admin'))
                                        <a href="{{ route('atur-barang', $ruang->_id) }}" class="btn btn-primary btn-sm">Atur Barang</a>
                                    @else
                                        <a href="{{ route('atur-barang', $ruang->_id) }}" class="btn btn-info btn-sm">Detail Barang</a>
                                    @endif
                                </td>
                            </tr>
                            @endforeach
