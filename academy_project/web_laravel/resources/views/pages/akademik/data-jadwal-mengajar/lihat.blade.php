                ...
                <div class="card-body px-0 pb-2">
                    <div class="table-responsive pb-2 px-3">
                        <table id="example" class="table align-items-center mb-0">
                            <thead>
                                <tr>
                                    <th class="text-center">No</th><th class="text-center">NIP</th><th class="text-center">Nama Guru</th><th class="text-center">Aksi</th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach ($guru_list as $g)
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="data-jadwalmengajar-cek/{{ $g->_id }}" class="btn btn-warning btn-sm rounded">Cek Jadwal</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
