...
@section('breadcrumbs')
    ...
    <h6 class="font-weight-bolder mb-0">Data Absensi Siswa</h6>
@endsection
          ...
          <div class="border border-2 rounded p-4 my-4 d-flex flex-column text-md" style="height: auto; max-height: 300px; position: relative;" id="presensiOptions">
            ...
            <form id="absensiForm" enctype="multipart/form-data">
                ...
                <div class="d-flex justify-content-end mt-3">
                    <button type="button" class="submit-button" onclick="submitAbsensiSiswa()" id="submitButton">Submit</button>
                </div>
            </form>
          </div>
...
<script>
    // ============================================
    // CHART - Hitung jumlah per status
    // ============================================
