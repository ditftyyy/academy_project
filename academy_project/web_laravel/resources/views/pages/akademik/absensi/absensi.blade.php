                        ...
                        <table id="example" class="table align-items-center mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center text-uppercase text-secondary text-xs font-weight-bolder opacity-7">Tahun Akademik</th>
                                        ...
                                        <td class="text-center" style="width: 20%;">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li><a class="dropdown-item" href="/akademik/absensi/{{ str_replace('/', '-', $akademik) }}/x">Kelas X</a></li>
                                                    <li><a class="dropdown-item" href="/akademik/absensi/{{ str_replace('/', '-', $akademik) }}/xi">Kelas XI</a></li>
                                                    <li><a class="dropdown-item" href="/akademik/absensi/{{ str_replace('/', '-', $akademik) }}/xii">Kelas XII</a></li>
                                                </ul>
                                            </div>
                                        </td>
                                    </tr>
