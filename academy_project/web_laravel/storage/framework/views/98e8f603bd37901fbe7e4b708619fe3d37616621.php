...
<head>
    ...
    <link rel="icon" type="image/png" href="<?php echo e(asset('assets/img/smart_scholl-only_icon.png')); ?>">
    <title><?php echo e($title ?? 'Academy+'); ?></title>
    ...
    <?php echo $__env->yieldContent('additional-js-top'); ?>
    <style>
        * {
...
<body class="g-sidenav-show px-0 bg-gray-200">
    ...
    <?php echo $__env->make('components.setting', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('components.js', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</body>
</html><?php /**PATH D:\Project Nanda\academy_project\academy_project\web_laravel\resources\views/components/main.blade.php ENDPATH**/ ?>