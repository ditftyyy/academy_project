...
<body class="bg-gray-200">
    ...
    <main class="main-content  mt-0">
        <div class="page-header align-items-start min-vh-100"
            style="background-image: url('<?php echo e(asset('assets/img/a.jpg')); ?>');">
                            ...
                            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                <div class="bg-gradient-primary shadow-primary border-radius-lg py-3 pe-1">
                                    <h4 class="text-white font-weight-bolder text-center mt-2 mb-0" style=""><img
                                            src="<?php echo e(asset('assets/img/smart_scholl-only_icon.png')); ?>"
...
unset($__errorArgs, $__bag); ?>>
                                ...
                                <div>
                                    ...
                                    <a href="<?php echo e(route('daftar-tamu')); ?>" class="teks-style"
...
<?php /**PATH D:\Project Nanda\academy_project\academy_project\web_laravel\resources\views/pages/auth/login.blade.php ENDPATH**/ ?>