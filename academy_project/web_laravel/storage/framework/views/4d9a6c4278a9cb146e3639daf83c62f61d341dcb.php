...
<head>
    ...
    <!-- CSS Files -->
    <link id="pagestyle" href="<?php echo e(asset('assets/css/material-dashboard.css?v=3.0.5')); ?>" rel="stylesheet" />
    <!-- Select2 -->
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card my-4">
                        ...
                        <div class="card-body">
                            <form action="<?php echo e(route('kirim-tamu')); ?>" method="post">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="mb-3 col-md-8" style="padding: 0 20px;">
                                    ...
                                    <input id="nama_tamu" type="text" name="namaTamu" class="form-control rounded-3"
                                        maxlength="20" value="<?php echo e(old('namaTamu')); ?>"
                                        <?php if($errors->has('namaTamu')): ?> autofocus <?php endif; ?>>
                                    <?php $__errorArgs = ['namaTamu'];
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="mb-3 col-md-8" style="padding: 0 20px;">
                                    ...
                                    <input id="input_alamat" type="text" name="alamatTamu" class="form-control"
                                        value="<?php echo e(old('alamatTamu')); ?>"
                                        <?php if($errors->has('alamatTamu')): ?> autofocus <?php endif; ?>>
                                    <?php $__errorArgs = ['alamatTamu'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="mb-3" style="padding: 0 20px;">
                                    ...
                                    <textarea class="form-control" name="keteranganTamu" rows="4" placeholder="Jelaskan tujuan kedatangan"><?php echo e(old('keteranganTamu')); ?></textarea>
                                    <?php $__errorArgs = ['keteranganTamu'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="card-footer d-flex justify-content-end" style="gap: 10px;">
                                    <a href="<?php echo e(route('login')); ?>" class="btn btn-danger text-sm rounded-3">
...
</html><?php /**PATH D:\Project Nanda\academy_project\academy_project\web_laravel\resources\views/pages/humas/daftar-tamu.blade.php ENDPATH**/ ?>